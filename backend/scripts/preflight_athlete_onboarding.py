...
"multiple_active_athlete_memberships":"SELECT count(*) FROM (SELECT athlete_profile_id FROM user_athlete_memberships WHERE role='athlete' AND is_active IS TRUE GROUP BY athlete_profile_id HAVING count(*)>1) q",
...
BASELINE={"users":"SELECT count(*) FROM users","owner_account_plans":"SELECT count(*) FROM users WHERE account_plan='owner'","athlete_account_plans":"SELECT count(*) FROM users WHERE account_plan='athlete'","coach_account_plans":"SELECT count(*) FROM users WHERE account_plan='coach'","athlete_profiles":"SELECT count(*) FROM athlete_profiles","memberships":"SELECT count(*) FROM user_athlete_memberships","owner_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE role='owner'",
"athlete_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE role='athlete'","coach_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE role='coach'","active_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE is_active IS TRUE","active_owner_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE role='owner' AND is_active IS TRUE","active_athlete_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE role='athlete' AND is_active IS TRUE","active_coach_memberships":"SELECT count(*) FROM user_athlete_memberships WHERE role='coach' AND is_active IS TRUE","active_defaults":"SELECT count(*) FROM user_athlete_memberships WHERE is_active IS TRUE AND is_default IS TRUE","deleted_athletes":"SELECT count(*) FROM athlete_profiles WHERE deleted_at IS NOT NULL","integration_accounts":"SELECT count(*) FROM integration_accounts","strava_accounts":"SELECT count(*) FROM integration_accounts WHERE provider='strava'"}
def run(connection):
