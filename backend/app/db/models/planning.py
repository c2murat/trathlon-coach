...
from app.db.base import Base, JSON_DOCUMENT, TimestampMixin, UUIDPrimaryKeyMixin
...
class CompetitionGoal(UUIDPrimaryKeyMixin, TimestampMixin, Base):
    ...
    __table_args__=(
      ...
      CheckConstraint("event_category IN ('triathlon','running','cycling','swimming')",name="competition_goal_category_valid"),
