...
from app.api.v1.routes.coach_assignments import router as coach_assignments_router
...
from app.api.v1.routes.planned_session_activity_links import router as planned_session_activity_links_router
...
def create_app() -> FastAPI:
    ...
    application.include_router(coach_assignments_router)
    ...
    application.include_router(planned_session_activity_links_router)
