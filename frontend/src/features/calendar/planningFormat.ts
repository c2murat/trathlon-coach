...
const workoutRoles:Record<string,string>={warmup:"Calentamiento",work:"Trabajo principal",recovery:"Recuperación activa",cooldown:"Vuelta a la calma",drill:"Técnica",strength:"Fuerza"};
const movementPatterns:Record<string,string>={KNEE_DOMINANT:"Dominante de rodilla",HIP_HINGE:"Bisagra de cadera",UNILATERAL_LOWER:"Pierna unilateral",CALF:"Gemelo",SOLEUS:"Sóleo",HORIZONTAL_PULL:"Tracción horizontal",HORIZONTAL_PUSH:"Empuje horizontal",CORE_ANTI_EXTENSION:"Core antiextensión",CORE_ANTI_ROTATION:"Core antirrotación",CORE_LATERAL:"Core lateral"};
/** Compatibility labels for artifacts created before step titles were snapshotted. */
export const workoutRoleLabel=(value?:string)=>workoutRoles[value??""]??"Bloque de entrenamiento";
export const movementPatternLabel=(value?:string)=>movementPatterns[value??""]??"Patrón de movimiento";
