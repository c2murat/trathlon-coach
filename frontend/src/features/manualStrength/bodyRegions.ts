...
export const BODY_REGION_LABELS:Record<BodyRegion,string>={full_body:"Cuerpo completo",chest:"Pecho",back:"Espalda",shoulders:"Hombros",arms:"Brazos",core:"Core",quadriceps:"Cuádriceps",hamstrings:"Isquiotibiales",glutes:"Glúteos",calves:"Gemelos"};
